...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BCM"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BCM"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BCM"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BCM"));
        ...
        labelBalance->setText(QStringLiteral("123.456 BCM"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for Bitcoin Money transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for Bitcoin Money transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        optInRBF->setText(QApplication::translate("SendCoinsDialog", "Request Replace-By-Fee", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        optInRBF->setToolTip(QApplication::translate("SendCoinsDialog", "Indicates that the sender may wish to replace this transaction with a new one paying higher fees (prior to being confirmed).", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
