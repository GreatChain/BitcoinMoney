...
public:
    CMainParams() {
        ...
        consensus.BCMForkHeight = 503288;//480000;
		consensus.BCMPremineBlock = 50000;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0); //MARK c 0
        ...
        checkpointData = (CCheckpointData) {
            {
                ...
                {503288, uint256S("0x06361ea40d0f0c643ae5f509f3a172aa0bee5977bd2a1ba9da6fabcb3ac93682")},
                {513287, uint256S("0x2061ab606763d9356a80c806ee866836a1e0eb99942c099e965181a0d56acf5a")},
            }
        };
